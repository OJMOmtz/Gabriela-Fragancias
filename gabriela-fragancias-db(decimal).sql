...
-- Tabla Municipio
CREATE TABLE gf.municipios (
    id_municipio SERIAL PRIMARY KEY,
    id_departamento INTEGER REFERENCES Departamento(id_departamentos),
...
CREATE TABLE gf.zona (
    id_zona SERIAL PRIMARY KEY,
    id_municipio INTEGER REFERENCES gf.municipios(id_municipios),
...
CREATE TABLE gf.detalles_venta (
    ...
    id_presentacion INTEGER REFERENCES gf.resentacion(id_presentacion) ON DELETE CASCADE,
