...
# Lee el archivo CSV con la codificación ISO-8859-1, omite las líneas con errores y especifica el carácter de cita
df = pd.read_csv(r'D:\PADRONES\csvs\.idea\CÉDULAS-2024-1_ISO-8859-1.csv', sep=';', encoding='ISO-8859-1', on_bad_lines='skip', quotechar='"')
