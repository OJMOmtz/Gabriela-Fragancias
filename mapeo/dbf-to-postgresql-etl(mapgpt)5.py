...
class ETLApp:
    ...
    def process_files(self):
        ...
        try:
            ...
            for i, file_path in enumerate(self.files_selected):
                ...
                for _, row in df.iterrows():
                    ...
                    for pg_col, combo in file_mapping.items():
                        ...
                        # Aplicar transformaciones específicas según la columna
                        if pg_col in ['fecha_nacimiento', 'fecha_defuncion']:
                ...
                columns = ', '.join(self.pg_columns)
                insert_query = f"INSERT INTO personas ({columns}) VALUES ({placeholders})"
            ...
            messagebox.showinfo("Éxito", "Archivos procesados y cargados correctamente en la base de datos.")
