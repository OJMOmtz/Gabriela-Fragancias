...
class DBFLoader:
    ...
    def process_record(self, record: Dict) -> Optional[tuple]:
        ...
        try:
            ...
            cedula = self.safe_str(record.get('cedula', record.get('NUMERO_CED', record.get('CEDULA', ''))))
            ...
            fecha_nac = None
            for field in ['fec_nac', 'FECHA_NAC', 'fechanac', 'FECHA_NACI', 'nacimiento']:
                if field in record:
            ...
            # Procesar sexo
            sexo = self.safe_str(record.get('sexo', record.get('CODIGO_SEX', '')))
            if sexo:
            ...
            self.logger.debug(
                ...
                f"Nombre: {nombre}\n"
                f"Apellido: {apellido}\n"
                f"Fecha Nac.: {fecha_nacimiento}\n"
                f"Sexo: {sexo}\n"
                f"Dirección: {direccion}"
            )
            
            return (cedula, nombre, apellido, sexo, fecha_nacimiento, direccion)
    ...
    def process_record(self, record: Dict) -> tuple:
        ...
        try:
            ...
            return (cedula, nombre, apellido, fec_nac, sexo, direcc)
