...
class CedulasLoader:
    ...
    def process_record(self, record):
        ...
        try:
            ...
            if not cedula.isdigit():
                self.logger.warning(f"Cédula inválida o vacía: {record}")
                return None
            ...
            self.logger.error(f"Error procesando registro: {record}, Error: {e}")
            return None
    ...
    def load_data(self):
        ...
        try:
            ...
            if failed_records:
                self.logger.warning(f"Registros fallidos: {len(failed_records)}")
