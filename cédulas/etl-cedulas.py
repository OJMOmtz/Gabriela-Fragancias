...
class CedulasETL:
    def __init__(self):
        ...
        self.column_patterns = {
            ...
            'regciv_2021.csv': {
                'numero_cedula': 'CEDULA,N,8,0',
                'nombre': 'NOMBRE,C,30',
                'apellido': 'APELLIDO,C,30',
                'fecha_nacimiento': 'FEC_NAC,D',
                'sexo': 'SEXO,C,1'
            }
        }
    ...
    def normalize_gender(self, gender: Any) -> str:
        ...
        return 'M' if gender in ['M', '1', 'MASCULINO'] else 'F' if gender in ['F', '2', 'FEMENINO'] else None
