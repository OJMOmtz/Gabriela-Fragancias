...
class DBFLoader:
    ...
    def process_record(self, record: Dict) -> tuple:
        ...
        processed_record = {
            ...
            'lugar_nacimiento': record.get('lugar_nac', '').strip(),
        ...
        for column in record.keys():
            ...
            if normalized_column not in processed_record:
                ...
                processed_record[normalized_column] = record[column]
        ...
        try:
            ...
            for table_path in self.tables:
                try:
                    ...
                    execute_batch(cur, """
                        INSERT INTO gf.cedulas 
                        (numero_cedula, nombre, apellido, sexo, fecha_nacimiento, direccion, id_distrito, id_dpto, zona, lugar_nacimiento, fecha_defuncion)
