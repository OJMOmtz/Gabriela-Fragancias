...
def cargar_archivos_csv_a_postgresql(archivos_csv, tabla_destino, batch_size=10000):
    ...
    try:
        ...
        for idx, (archivo_csv, estructura) in enumerate(archivos_csv.items(), 1):
            ...
            try:
                ...
                datos = [tuple(x) for x in registros_validos[columnas_a_insertar].values]
                
                # Insertar datos en lotes con barra de progreso optimizada
                start_time = time()
