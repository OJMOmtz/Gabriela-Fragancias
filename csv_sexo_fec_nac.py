...
# Lee el archivo CSV
df = pd.read_csv(r'D:\PADRONES\csvs\.idea\CÉDULAS-2024-1_ISO-8859-1.csv', sep=';')
...
df.to_csv(r'D:\PADRONES\csvs\.idea\CÉDULAS-2024-1_ISO-8859-1_nuevo.csv', sep=';', index=False)